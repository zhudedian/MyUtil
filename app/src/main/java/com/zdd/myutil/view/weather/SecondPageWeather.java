...
public class SecondPageWeather extends ViewGroup {
    ...
    String[] viewType = new String[viewCount];
    String[] dates = new String[viewCount];
    String[] lowTemps = new String[viewCount];
    String[] highTemps = new String[viewCount];

    public SecondPageWeather(Context context) {
        this(context, null);
    }

    public SecondPageWeather(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SecondPageWeather(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        viewWidth =  (width-viewSpan*(4+1))/4;
//        initData();
